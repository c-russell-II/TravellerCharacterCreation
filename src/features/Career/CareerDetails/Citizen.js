export const citizen = {
    ...
    eventList: {
        2: {type: 'redirect', destination: 'mishap'},
        3: {type: null},
        ...
        8: {type: 'choice', description: "You learn something you shouldn't have- a corporate secret, a political scandal - which you can profit from illegally, if you choose.", choiceList: ['a', 'b'],
            a: {description: 'You either meet someone capable of helping you, or learn a bit about navigating this sort of backroom dealing, and make a tidy profit.', 
                results: {type: 'choice', choiceList:['a', 'b'], choiceDetail: {a: 'multiple', b: 'multiple'},
                    a: {type: 'multiple', list: ['a', 'b'], listDetail: {a: 'benefit', b: 'choice'},
                        ...
                        b: {type:'choice', choiceType: 'setSkill', choice:['Streetwise', 'Investigate'], choiceDetails: {Streetwise: 'skill', Investigate: 'skill'}, value: 1}},
            ...
            b: {description: 'You refuse to take advantage, earning little, but keeping your honor intact.', results: null, button: "Stay away"},},},
        ...
        11: {type: 'reward', description: 'You befriend a superior in the corporation or colony.', result: {type: 'multiple', list: ['choice', 'ally'], choice: {type: 'choice', choice: ['Tactics', 'advancement'], choiceDetail: {'Tactics': 'skill', 'advancement':'advancement'}}, ally: {type: 'ally', value: 1, description: 'Superior from your time as a Citizen.'}},
    ...
    skills: {
        ...
        service: [
            ...
            {type: 'skill', skill:'Flyer', specialty:'any'},
            {type: 'skill', skill:'Streetwise', specialty: false},
            {type: 'skill', skill:'Melee', specialty: 'any'},
            {type: 'skill', skill:'Steward', specialty: false},
            {type: 'skill', skill:'Profession', specialty: 'any'},
        ],
        advanced: [
            {type: 'skill', skill:'Art', specialty: 'any'},
            {type: 'skill', skill:'Advocate', specialty: false},
            {type: 'skill', skill:'Diplomat', specialty: false},
            {type: 'skill', skill:'Language', specialty: 'any'},
            {type: 'skill', skill:'Electronics', specialty: 'computers'},
            {type: 'skill', skill:'Medic', specialty: false},
        ],
        specialties: {
            corporate: [
                {type: 'skill', skill:'Advocate', specialty: false},
                {type: 'skill', skill:'Admin', specialty: false},
                {type: 'skill', skill:'Broker', specialty: false},
                {type: 'skill', skill:'Electronics', specialty: 'computers'},
                {type: 'skill', skill:'Diplomat', specialty: false},
                {type: 'skill', skill:'Leadership', specialty: false},
            ],
            worker: [
                {type: 'skill', skill:'Drive', specialty:'any'},
                {type: 'skill', skill:'Mechanic', specialty: false},
                {type: 'skill', skill:'Electronics', specialty: 'any'},
                {type: 'skill', skill:'Engineer', specialty: 'any'},
                {type: 'skill', skill:'Profession', specialty: 'any'},
                {type: 'skill', skill:'Science', specialty: 'any'},
            ],
            colonist: [
                {type: 'skill', skill:'Animals', specialty: 'any'},
                {type: 'skill', skill:'Athletics', specialty: 'any'},
                {type: 'skill', skill:'JackOfAllTrades', specialty: false},
                {type: 'skill', skill:'Drive', specialty: 'any'},
                {type: 'skill', skill:'Survival', specialty: false},
                {type: 'skill', skill:'Recon', specialty: false},
            ]
        }
    },
    benefits: [
