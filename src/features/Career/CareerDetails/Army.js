export const army = {
    ...
    eventList: {
        ...
        3: {type: 'reward', description: 'You are assigned to a planet with a hostile or wild environment.', result:{type: 'choice', choice: ['VaccSuit', 'Engineer', 'Animals', 'Recon'], choiceDetail:{'VaccSuit':'skill', 'Enginner':'skill', 'Animals':'skill', 'Recon':'skill'}, value: 1}},
        4: {type: 'reward', description: 'You are assigned to an urbanised planet torn by war.', result:{type: 'choice', choice: ['Stealth', 'Streetwise', 'Persuade', 'Recon'], choiceDetail:{'Stealth':'skill', 'Streetwise':'skill', 'Persuade':'skill', 'Recon':'skill'}, value: 1}},
        ...
        6: {type: 'check', checkType: 'stat', checkStat: 'edu', checkDC: 8, description: 'You are thrown into a brutal ground war.',
                pass: {description: 'You avoid injury through the entire war, and improve your skills.', result: {type: 'choice', choice: ['GunCombat', 'Leadership'], value: 'increase'}},
    ...
    mishapList: [
        ...
        {type: 'enemy', description: 'Your unit is slaughtered in a disastrous battle, for which you blame your commander. In retaliation, said commander has you removed from service.', result: {type: 'enemy', value: 1}},
        ...
        {type: 'choice', description: 'You discover that your commanding officer is engaged in some illegal activity, such as weapon smuggling.', choiceList: ['a', 'b'],
            a: {description: 'You join their ring for a time, until the inevitable investigation gets you discharged.', results: {type: 'ally', value: 1, description: 'Commanding officer you commited crimes with.'}, button: 'Join them'},
            b: {description: 'You choose to co-operate with the military police, ', results: 'benefit', button: 'Cooperate with MPs'},},
        {type:'rival', description: 'You are tormented by or quarrel with an officer or fellow soldier. That officer drives you out of the serivce.', result: {type: 'rival', value: 1, description: 'Drove you out of army career'}},
