...
export const UniversityChoice = () => {
    ...
    const jobArray = useSelector((state: RootState)=> state.careers.jobArray);
    ...
    return (
		<div>
			<h2 className={styles.choiceHeader}>
				You're officially an adult, with choices laid out in front of
				you...
			</h2>
			<p>
				Now what? You can choose to do pre-career education, either via
				your planetary university, or through the military academy.
			</p>
			<p>
				Alternatively, you can jump straight into pursuing a career of
				your choice, skipping out on the extra time in school.
			</p>
			{choiceButtons && (
				<UniChoices
			...
			<BranchChoice
				...
				setToCareers={setToCareers}
			/>
			<Popup open={milAcademy.pass} modal>
				<h5>
					You've qualified your planetary {milAcademy.branch}'s
					military academy!
				</h5>
			...
			{toCareers && (
				<>
					<h4>Tough luck.</h4>
					<p>
						You failed to qualify for your chosen school- but you
						still qualify to try to enroll for the first three terms
						of your life.
					</p>
