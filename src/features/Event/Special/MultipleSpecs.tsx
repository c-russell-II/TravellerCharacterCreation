    ...
    return (
        <>
            <form onSubmit={handleSubmit} name="specialties">
                {skills.Science.specialtiesList.map((e: string, i: number) => <input name="specialties" type="checkbox" key={i} value={e} checked={isChecked.includes(e)} onChange={handleChange}>{e}</input>)}
