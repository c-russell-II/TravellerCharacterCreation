...
export const thief = {
	...
	ranks: [
		...
		{
			title: "Pickpocket",
			bonus: { type: "skill", skill: "Stealth", value: 1 },
		},
...
export const enforcer = {
	...
	ranks: [
		...
		{ title: "Thug", bonus: false },
		{
			...
			bonus: {
				type: "choice",
				list: ["GunCombat", "Melee"],
				specialties: { GunCombat: "any", Melee: "any" },
				value: 1,
			},
		},
	...
	ranks: [
		{ title: "Lackey", bonus: false },
		{
			...
			bonus: {
				type: "choice",
				list: ["Pilot", "Gunner"],
				specialties: { Pilot: "any", Gunner: "any" },
				value: 1,
			},
		},
		...
		{ title: "Lieutenant", bonus: false },
		{
			...
			bonus: {
				type: "choice",
				list: ["Engineer", "Navigation"],
				specialties: { Engineer: "any", Navigation: null },
			},
		},
