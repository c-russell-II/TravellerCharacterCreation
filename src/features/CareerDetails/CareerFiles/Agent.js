export const agent = {
	...
	eventList: {
		...
		8: {
			...
			pass: {
				description:
					"You manage to successfully infilitrate their ranks...",
				type: "special",
				specialType: "redirectChoice",
				pass: true,
			},
			fail: {
				description: "You fail to deceive your targets...",
				type: "special",
				specialType: "redirectChoice",
				pass: false,
			},
	...
	mishapList: [
		...
		},
		{
			...
			fail: {
				type: "prisoner",
				description:
					"You are unable to successfully defend yourself, landing in jail...",
				result: "prisoner",
			},
		},
...
export const lawEnforcement = {
	...
	ranks: [
		{ title: "Rookie", bonus: false },
		{
			title: "Corporal",
			rank: 1,
			bonus: { type: "skill", skill: "Streetwise", value: 1 },
		},
