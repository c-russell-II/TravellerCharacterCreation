export const scholar = {
    title: 'Scholar',
    description: "Individuals trained in technological or research sciences who conduct scientific investigations into materials, situations and phenomena, or who practise medicine.",
    qualification: true,
    ...
    eventList: {
        ...
        4: {type: 'reward', description: 'You are assigned to work on a secret project for a patron or organization.',
            result: {type: 'choice',
                choiceType: 'setSkill',
                choiceList: ['Medic', 'Science', 'Engineer', 'Electronics', 'Investigate'],
                specialtyList: {Medic: null, Science: 'any', Engineer: 'any', Electronics: 'any', Investigate: null},
                value: 1
            }
        },
        5: {type: 'reward', description: "You win a prestigious prize for your work, garnering both the praise and envy of your peers.",
        ...
        8: {type: 'choice', choiceList:['a', 'b'], description: "You have an opportunity to cheat in some fashion, advancing your own causes by stealing another's work, using an alien device, taking an unethical shortcut, etc.",
            ...
            b: {button: "It'd be Wrong.", description: "You follow your conscience, keeping your heart clear, but at what cost...?", result: {type: 'none'}}
        },
        9: {type: 'reward', description: "You make a breakthrough in your field.", result: {type: 'advancement', value: 2}},
        10: {type: 'reward', description: "You become entangled in a bureaucratic or legal morass that distracts you from your work.",
            result: {type: 'choice',
                choiceType: 'setSkill',
                choiceList: ['Admin', 'Advocate', 'Persuade', 'Diplomat'],
                specialtyList: {Admin: null, Advocate: null, Persuade: null, Diplomat: null},
                value: 1
            }
        },
        11: {type: 'reward', description: 'You work for an eccentric but brilliant mentor.',
            result: {type: 'multiple',
                list: ['ally', 'choice'],
                ally: {type: 'ally', value: 1, description: 'An eccentric but brilliant person who mentored you during your time as a Scholar.'},
                choice: {type: 'choice',
                    choiceType: 'multiple',
        ...
        12: {type: 'reward', description: "Your work leads to a considerable breakthrough.", result: {type: 'promotion'}}
    },
    mishapList: [
        {type: 'redirect', destination: 'injury table', modifier: 'disadvantage'},
        {type: 'reward', description: "A disaster leaves several injured, and others blame you- fairly or not.",
            result: {type: 'multiple',
                list: ['rival', 'redirect'],
                rival: {type: 'rival', value: 1, description: "Someone who blames you for a disaster that injured several people, during your stint as a Scholar."},
                redirect: {type: 'redirect', destination: 'injury', modifier: 'advantage'}
            }
        },
        ...
        {type: "reward", description: "An expedition or voyage goes wrong, leaving you stranded in the wilderness... and by the time you find your way home, your job is gone.",
            result: {type: 'choice',
                choiceType: 'setSkill',
                choiceList: ['Survival', 'Athletics'],
                specialtyList: {Survival: null, Athletics: ['dexterity', 'endurance']},
                value: 1
            }
        },
...
export const fieldResearcher = {
    ...
    ranks: [
        ...
        {title: 'Field Assistant', bonus: {type: 'skill', skill: 'Science', specialties: 'any', value: 1}},
        {title: 'Inquirer', bonus: {type: 'skill', skill: 'Electronics', specialties: 'computers', value: 1}},
        {title: 'Junior Investigator', bonus: {type: 'skill', skill: 'Investigate', value: 1}},
        {title: 'Investigator', bonus: false},
        {title: 'Principal Investigator', bonus: {type: 'skill', skill: 'Science', specialties: 'any', value: 2}},
...
export const scientist = {
    title: 'Scientist',
    description: 'You are a researcher in some corporation or research institution, or a mad scientist in an orbiting laboratory.',
    survivalSkill: 'edu',
    survivalDC: 4,
    advancementSkill: 'int',
    advancementDC: 8,
    ...
    ranks: [
        ...
        {title: 'Intern', bonus: {type: 'skill', skill: 'Science', specialties: 'any', value: 1}},
        {title: 'Junior Assistant', bonus: {type: 'skill', skill: 'Electronics', specialties: 'computers', value: 1}},
        {title: 'Lab Assistant', bonus: {type: 'skill', skill: 'Investigate', value: 1}},
        {title: 'Research Fellow', bonus: false},
        {title: 'Head Researcher', bonus: {type: 'skill', skill: 'Science', specialties: 'any', value: 2}},
...
export const physician = {
    ...
    ranks: [
        ...
        {title: 'Resident Physician', bonus: {type: 'skill', skill:'Medic', value: 1}},
        {title: 'Senior Resident', bonus: false},
        {title: 'Licensed Physician', bonus: {type: 'skill', skill: 'Science', specialties: 'any', value: 1}},
        {title: 'Attending Physician', bonus: false},
        {title: 'Senior Physician', bonus: {type: 'skill', skill: 'Science', specialties: 'any', value: 2}},
