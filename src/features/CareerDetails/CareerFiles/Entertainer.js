	...
	eventList: {
		...
		8: {
			...
			a: {
				...
				fail: {
					type: "reward",
					description: "You fail to bring down the political leader.",
					result: {
						type: "multiple",
		...
		9: {
			...
			result: { type: "contacts", value: "roll", roll: 2 },
		},
		10: {
			type: "reward",
			description:
			...
			Performer: [
				{
					type: "skill",
					skill: "Art",
					specialty: ["performer", "instrument"],
				},
...
export const artist = {
	...
	ranks: [
		{ title: "Starving Artist", bonus: false },
		{
			...
			bonus: { type: "skill", skill: "art", specialty: "any", value: 1 },
		},
