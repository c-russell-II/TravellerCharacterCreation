export const psion = {
	...
	eventList: {
		...
		4: {
			type: "reward",
			description:
				"You spend significant amounts of time mastering your mind and body, and your skills grow to reflect this.",
			result: {
				type: "choice",
				choiceType: "setSkill",
		...
		5: {
			type: "choice",
			description:
				"You have a chance to use your psionic powers unethically.",
			choiceList: ["a", "b"],
			a: {
				button: "Do it.",
				type: "check",
				...
				pass: {
					type: "reward",
					description: "Your attempt bears profitable fruit.",
					result: {
						type: "choice",
						choiceType: "multiple",
						list: ["addBenefit", "stat"],
						addBenefit: {
							type: "addBenefit",
							button: "Plus One Benefit",
						},
						stat: {
							type: "stat",
							stat: "soc",
							value: 1,
							button: "Social Standing + 1",
						},
					},
				},
				fail: {
					type: "reward",
					description: "Your attempt backfires.",
					result: { type: "stat", stat: "soc", value: -1 },
				},
			},
			b: {
				button: "Refrain.",
				description: "You let your better judgement prevail.",
				type: "generic",
			},
		},
		6: {
			...
			result: {
				type: "contact",
				description:
					"An unexpected connection, outside your normal circles, from your time as a Psion.",
				value: 1,
			},
		},
		...
		8: {
			type: "reward",
			description: "You achieve a new level of Psionic strength.",
			result: { type: "stat", stat: "psi", value: 1 },
		},
		9: {
			type: "check",
			checkType: "stat",
		...
		10: {
			type: "reward",
			description:
				"You pick up potentially useful information from your passive Psionic powers.",
			result: { type: "benefit", value: 1 },
		},
		11: {
			type: "reward",
			description: "You gain a mentor.",
			result: {
				type: "multiple",
				...
				ally: {
					type: "ally",
					value: 1,
					description: "Mentor from Psion career.",
				},
		...
		12: {
			type: "reward",
			description:
				"You achieve a new level of discipline with your powers.",
	...
	mishapList: [
		...
		},
		{
			type: "reward",
			description:
				"You telepathically contact something dangerous, and are plagued by consistent, terrifying nightmares.",
			result: { type: "stat", stat: "psi", value: -1 },
		},
		{ type: "other" },
		{
			type: "choice",
			description:
				"You are asked to use your psionic powers in an unethical fashion.",
			choiceList: ["a", "b"],
			a: {
				type: "reward",
				button: "Agree.",
				description:
					"You do so, and it turns out to have been a test- you have been approved to continue your training.",
				result: {
					type: "multiple",
					list: ["noMuster", "enemy"],
					...
					enemy: {
						...
						value: 1,
						description:
							"Someone you hurt doing something unethical during your psion career.",
					},
				},
			},
			b: {
				...
				button: "Refuse",
				description:
					"It was a test by your superiors, and they decide you are not a good fit for continued enrollment in their organization.",
			},
		},
		{
			type: "reward",
			description:
				"You are experimented on by a corporation, government, or other powerful organization - you escape, but cannot return to your psionic career.",
		},
...
export const wildTalent = {
	...
	ranks: [
		{ title: "Neophyte", bonus: false },
		{
			...
			bonus: {
				type: "choice",
				choiceList: ["Survival", "Streetwise"],
				value: 1,
			},
		},
		...
		{
			title: "Witch",
			bonus: { type: "skill", skill: "Deception", value: 1 },
		},
...
export const adept = {
	...
	ranks: [
		...
		{
			title: "Acolyte",
			bonus: { type: "talent", talent: "any", value: 1 },
		},
...
export const psiWarrior = {
	...
	ranks: [
		...
		{
			title: "Senior Marine",
			bonus: { type: "skill", skill: "GunCombat", value: 1 },
		},
		{
			title: "Captain",
		...
		{
			title: "Force Lieutenant",
			bonus: { type: "skill", skill: "Tactics", value: 1 },
		},
		{ title: "", bonus: false },
		{ title: "", bonus: false },
	],
