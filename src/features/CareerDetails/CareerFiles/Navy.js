	...
	mishapList: [
		...
		{ type: "special", specialType: "branchSkillCheck" },
		{
			...
			a: {
				button: "It was you...",
				description:
					"Your shame drives you to excel before your court martial sees you ejected from the career.",
				type: "special",
				specialType: "table",
			},
			b: {
	...
	benefits: [
		{
			money: 1000,
			misc: "choice",
			choiceList: ["Personal Vehicle", "ShipShare"],
			"Personal Vehicle": { type: "misc" },
			ShipShare: { type: "misc", value: 1 },
		},
		{ money: 5000, misc: "int", miscValue: 1 },
		{
			money: 5000,
			misc: "choice",
			choiceList: ["edu", "ShipShare"],
			edu: { type: "stat", value: 1 },
			ShipShare: { type: "misc", value: 2 },
		},
		...
		{ money: 20000, misc: "TAS" },
		{
			money: 50000,
			misc: "choice",
			choiceList: ["Ships Boat", "ShipShare"],
			"Ships Boat": { type: "misc" },
			ShipShare: { type: "misc", value: 2 },
		},
...
export const lineCrew = {
	...
	ranks: [
		{ title: "Crewman", bonus: false },
		{
			...
			bonus: { type: "skill", skill: "Mechanic", value: 1 },
		},
		{
