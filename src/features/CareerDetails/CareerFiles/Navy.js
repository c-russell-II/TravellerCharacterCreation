export const navy = {
    ...
    eventList: {
        ...
        5: {type: 'check', checkType: 'stat', checkStat: 'edu', checkDC: 8, description: 'You are offered an opportunity for advanced, specialist training.',
            ...
            fail: {type: 'generic', description: "You do not manage to measure up to your instructors' standards."}},
    ...
    mishapList: [
        ...
        {type: 'reward', description: "You were woken from cryosleep improperly.", noMuster: true, result: {type: 'choice', choiceType: 'stat', choiceList: ['str', 'dex', 'end'], value: -1}},
        ...
        {type: 'choice', description: "You were blamed for an accident that causes the deaths of several of your crewmates.", choiceList: ['a', 'b'],
            a:{button: 'It was you...', description: "Your shame drives you to excel before your court martial sees you ejected from the career.", type: 'special', specialType: 'table'},
...
export const lineCrew = {
    ...
    comRanks: [
        {title: 'Ensign', bonus: {type: 'skill', skill: 'Melee', specialty: 'blade', value: 1}},
        {title: 'Sublieutenant', bonus: {type: 'skill', skill: 'Leadership', value: 1}},
        {title: 'Lieutenant', bonus: false},
        {title: 'Commander', bonus: {type: 'skill', skill: 'Tactics', specialty: 'naval', value: 1}},
        {title: 'Captain', bonus: {type: 'setStat', stat: 'soc', threshold: 10, value: 1}},
        {title: 'Admiral', bonus: {type: 'setStat', stat: 'soc', threshold: 12, value: 1}},
    ],
    skills: navy.skills,
