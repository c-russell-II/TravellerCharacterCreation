...
import { CareerInfo, resolveBenefit } from "../../features/Career/careerSlice";
...
const BenefitsContainer = () => {
	...
	const careerInfo = useSelector(
		(state: RootState) => state.careers.careerInfo[career as string]
	);
	const { rankBonus, numBenefits, benefitTables } =
		extractCareerInfo(careerInfo);
