...
const lifeEvent: {[key: number]: AnyEvent} = {
    ...
    11: {type: 'choice', choiceList: ['a', 'b'], description: "You are accused of a crime, and must decide if fighting the charge is worth the monetary cost.",
        choice: {
            a: {button: "Pay it!", type: 'reward', description: "Throwing some money at it made the charge mysteriously fall apart. How shocking.", result: {type: 'loseBenefit'}},
            //TODO: fix special event in generic life event table!
            b: {button: "Don't pay!", type: 'special', specialType: 'prisoner'}
        }
    },
    12: {type: 'redirect', destination: 'unusual'}
}

const unusual: AnyEvent[] = [
...
const prisonEvent: AnyEvent[] = [
    ...
    {type: 'special', specialType: "ParoleReroll"},
    {type: 'special', specialType: 'ParoleMinusTwo'},
