	...
	return (
		<>
			{intro && (
				<>
					<p>
						You are offered the chance to participate in a risky,
						but rewarding venture- and accept...
					</p>
			...
			{badChoice && (
				<>
					<p>
						The venture goes sideways- choose between injury, or
						prison, as you struggle to deal with the consequences...
					</p>
					<button
						onClick={() =>
							dispatch(
			...
			{nothing && (
				<>
					<p>
						Nothing goes especially wrong - but you don't get much
						out of the venture, either.
					</p>
